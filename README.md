...
#Если при запуске контейнера пишет, что порт redis занят, то возможно redis запущен на хосте, в любом случае, нужно его остановить.
```bash
# Остановить Redis 
redis-cli shutdown

# Если Redis на другом порту
redis-cli -p 6379 shutdown

# Принудительно остановить (без сохранения)
